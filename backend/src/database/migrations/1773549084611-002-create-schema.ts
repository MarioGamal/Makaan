...
export class CreateSchema1773549084611 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."listings_property_type_enum" AS ENUM('Apartment', 'Villa', 'Duplex', 'Penthouse', 'Studio', 'Townhouse', 'Chalet')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."listings_finishing_level_enum" AS ENUM('Semi-finished', 'Fully finished', 'Luxury finished')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."listings_status_enum" AS ENUM('draft', 'submitted', 'active', 'rejected', 'sold', 'inactive')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."listings_rejection_reason_enum" AS ENUM('incomplete_data', 'inaccurate_location', 'duplicate', 'spam_scam')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."seller_profiles_seller_type_enum" AS ENUM('owner', 'agent')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_user_type_enum" AS ENUM('buyer', 'seller', 'admin')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."users_status_enum" AS ENUM('active', 'blocked', 'deactivated')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cairo_areas" ADD CONSTRAINT "FK_9fb86852176e0216ef364337e39" FOREIGN KEY ("parent_id") REFERENCES "cairo_areas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "photos" ADD CONSTRAINT "FK_9e51f248dd72d05fd97e8ecf32b" FOREIGN KEY ("listing_id") REFERENCES "listings"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "listings" ADD CONSTRAINT "FK_844247dce636c3f6950de2dc72c" FOREIGN KEY ("area_id") REFERENCES "cairo_areas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "listings" DROP CONSTRAINT "FK_844247dce636c3f6950de2dc72c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "listings" DROP CONSTRAINT "FK_6d2846ee6b337ce5225c8c7286b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "photos" DROP CONSTRAINT "FK_9e51f248dd72d05fd97e8ecf32b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cairo_areas" DROP CONSTRAINT "FK_9fb86852176e0216ef364337e39"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."seller_profiles_seller_type_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."listings_rejection_reason_enum"`,
    );
    await queryRunner.query(`DROP TYPE "public"."listings_status_enum"`);
    await queryRunner.query(
      `DROP TYPE "public"."listings_finishing_level_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_CAIRO_AREAS_BOUNDARY_GIST"`,
    );
